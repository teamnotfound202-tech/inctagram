...
type Props = {
  changeReadUser: (value: User) => void
}

export const MessengerUsers = ({ changeReadUser }: Props) => {
        ...
        {messengersUsersItems.map(user => (
          ...
          >
            ...
            <div className={s.usersWindowItemContent}>
              ...
              <div className={s.usersWindowItemText}>{user.messageText}</div>
            </div>
          </li>
        ))}
